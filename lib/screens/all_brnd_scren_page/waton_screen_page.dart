                      ...
                      itemBuilder: (context, index) {
                        return InkWell(onTap: () {
                          Get.to(PhotoViewgallry(
                            photo1: controller.waltonDetails[index].fullphoto,
                            photo2: controller.waltonDetails[index].sidephoto,
                            photo3: controller.waltonDetails[index].thirdphoto,
                            photo4: controller.waltonDetails[index].forthphoto,
                            photo5: controller.waltonDetails[index].fifthphoto,
                            photo6: controller.waltonDetails[index].sixthphoto,
                            photo7: controller.waltonDetails[index].saventhphoto,
                          ));
                        },
                          child: Card(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                        child: CircleAvatar(
                                          ...
                                          child: Image.network(
                                            controller.waltonDetails[index].png,
                                          ),
                                        ),
                                        flex: 2,
                                      ),
                                      Expanded(
                                        ...
                                        child: Column(
                                          ...
                                          children:[
                                            Text(
                                              controller.waltonDetails[index].name,
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                  controller.waltonDetails[index].bkrun,
                                                  style: GoogleFonts.lato(
                                                    color: Colors.white,
                                                  ),
                                                ),
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                  controller.waltonDetails[index].cc,
                                                  style: GoogleFonts.lato(
                                                    color: Colors.white,
                                                  ),
                                                ),
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                  controller.waltonDetails[index].price,
                                                  style: GoogleFonts.lato(
                                                    color: Colors.white,
                                                  ),
                                                ),
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                  controller.waltonDetails[index].engcondition,
                                                  style: GoogleFonts.lato(
                                                    color: Colors.white,
                                                  ),
                                                ),
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                  controller.waltonDetails[index].papers,
                                                  style: GoogleFonts.lato(
                                                    color: Colors.white,
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                  controller.waltonDetails[index].bncng,
                                          ...
                                          children: <Widget>[
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(controller.waltonDetails[index].health,style: GoogleFonts.lato(
                                                  color: Colors.white,
                                                  fontSize: height*0.01,
                                                ),),
                                              ],
                                            ...
                                            Column(
                                              children: [
                                                ...
                                                Text(controller.waltonDetails[index].model,style: GoogleFonts.lato(color: Colors.white,fontSize: height*0.009)),
