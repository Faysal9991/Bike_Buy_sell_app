...
class RunnerDtailsPage extends StatelessWidget {
  ...
  final runnerBikeDetailsController = Get.put(RunnerController());
  @override
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(controller.runnerDetails[index].name,style: GoogleFonts.lato(fontSize: height*0.03,fontWeight: FontWeight.bold),),
                              ],
                            ),
                          ),
                        ),
