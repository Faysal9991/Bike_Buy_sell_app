...
class HeroDtailsPage extends StatelessWidget {
  HeroDtailsPage({Key? key}) : super(key: key);
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(controller.heroDetails[index].name,style: GoogleFonts.lato(fontSize: height*0.03,fontWeight: FontWeight.bold),),
                              ],
                            ),
                          ),
                        ),
