...
class SuziKiDtailsPage extends StatelessWidget {
  ...
  final suzukiBikeDetailsController = Get.put(SuzukiController());
  @override
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(controller.suzukiDetails[index].name,style: GoogleFonts.lato(fontSize: height*0.03,fontWeight: FontWeight.bold),),
                              ],
                            ),
                          ),
                        ),
